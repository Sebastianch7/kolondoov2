                        ...
                        <Row>
                            <Col xs={12}>
                                ...
                                <p className='my-md-3 px-2 p-md-0'>
                                    <b>Los suministros básicos de cada hogar son la <a href='/es/blog/energia/tarifa-indexada-y-pvpc-diferencias' target='_self'>luz</a>, el <a href='/es/blog/energia/ahorrar-en-tarifa-de-gas-natural' target='_self'>gas</a> y el agua potable.</b> En otras palabras, son los servicios más esenciales en una vivienda que cubren las necesidades más importantes de nuestro día a día.
                                </p>
                                <p className='my-md-3 px-2 p-md-0'><b>Además, a estos servicios podríamos sumarle en los últimos años Internet, ya que cada vez se vuelve más necesario contratar una <a href='/es/internet-telefonia/comparador-fibra' target='_self'>tarifa de fibra óptica</a></b> (o ADSL si aún no tienes cobertura de fibra en tu edificio), y es que está normalizándose teletrabajar a tiempo parcial o completo.</p>
                            ...
                            <Col xs={12}>
                                ...
                                <p className='my-md-3 px-2 p-md-0'>Desde Kolondoo te recomendamos que <b>compruebes el <a href="/es/herramientas/precio-de-la-luz-hoy" target='_self'>precio de la luz por horas</a></b>, para ser consciente de cuándo está más barata y más cara la electricidad y puedas ahorrar en tu factura.</p>
                                    ...
                                    <Card.Body>
                                        <ul className='icon-list'>
                                            ...
                                            {fetchBlog?.map((item, index) => {
                                                return < a target='_self' key={index} href={`/es/herramientas/suministros/${item.url_amigable}`}><li className='m-3 font-semibold'>{`${item.titulo}`}</li></a>
                                            })
                                            }
                                        </ul>
                                    </Card.Body>
