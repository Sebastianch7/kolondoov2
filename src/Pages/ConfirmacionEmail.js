                    ...
                    <div className="col-md-8">
                        <div className="card text-center">
                            <div className="card-body">
                                <img src="https://www.vuskoo.com/img/logos/logo.svg" alt="Vuskoo" className="img-fluid" style={{ maxWidth: '150px' }} />
                                <hr />
                                <h1 className="card-title text-danger my-5">Error al verificar tu correo</h1>
                                <p className="card-text">Hubo un problema verificando tu cuenta. Por favor, intenta nuevamente más tarde.</p>
                                <a href="/" className="btn btn-danger mt-3">Volver al inicio</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="col-md-8">
                        <div className="card text-center">
                            <div className="card-body">
                                <img src="https://www.vuskoo.com/img/logos/logo.svg" alt="Vuskoo" className="img-fluid" style={{ maxWidth: '150px' }} />
                                <hr />
                                <h1 className="card-title text-primary my-5">¡Gracias por verificar tu correo!</h1>
                                <p className="card-text">Tu cuenta ha sido verificada exitosamente. Ahora podrás recibir nuestras actualizaciones y las últimas novedades directamente en tu bandeja de entrada.</p>
