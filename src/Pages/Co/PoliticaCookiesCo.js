                ...
                <Container>
                    <Row>
                        <Col md={12}>
                            ...
                            <p>Esta Política de Cookies forma parte y complementa la  <a className='color-primary no-link' href='/co/politica-privacidad'><b>Política de Privacidad</b></a> del sitio web (en adelante, el “sitio web”). El titular es KOLONDOO MEDIA, S. L., sociedad de nacionalidad española, con NIF B-16756041, y domicilio social en la Calle Barquillo, 8 planta, 1º izquierda, 28004 Madrid (España), (en adelante conjuntamente designadas como “Kolondoo”).</p>
                            ...
                            <p>En general, estas tecnologías pueden servir para finalidades muy diversas, como, por ejemplo, reconocerte como usuario, obtener información sobre tus hábitos de navegación, o personalizar la forma en que se muestra el contenido. Los usos concretos que hacemos de estas tecnologías se describen a continuación. No obstante, no pueden dañar el equipo/dispositivo del usuario.</p>
                            <Title titleAlt={'¿Qué tipos de cookies'} titleThird={'utiliza este sitio web?'} />
                            <p>Este sitio web cookies propias y de terceros generadas desde otros sitios web ajenos a Kolondoo, pertenecientes a asociados y terceras entidades que operan en la red, para las finalidades concretas que se exponen abajo. Ten en cuenta que, si aceptas las cookies de terceros, deberás eliminarlas desde las opciones del navegador o desde el sistema ofrecido por el propio tercero en caso de que posteriormente quieras retirar tu consentimiento. Consulta sus respectivas Políticas de Privacidad para una mayor información.</p>
                            <p>Las cookies pueden ser persistentes o de sesión. Las cookies persistentes son aquellas en las que los datos siguen almacenados en el terminal y a los que se puede acceder y tratar durante un periodo definido por el responsable de la cookie. Puede permanecer desde de unos minutos a varios años.</p>
                            <p>Las cookies de sesión, por su parte, son cookies diseñadas para recabar y almacenar datos mientras el usuario accede a una página web. Se suelen utilizar para almacenar información que solo interesa conservar para la prestación del servicio solicitado por el usuario en una sola ocasión.</p>
                            <Title title={'(i)'} titleAlt={'Cookies'} titleThird={'técnicas y estrictamente necesarias'} />
                            ...
                            <p><b>Listado de cookies técnicas y estrictamente necesarias:</b></p>
                            <table class="table table-bordered table-width">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>1 minuto</td>
                                        <td><a href="/co/politica-privacidad">Pol.Priv.</a></td>
                                    </tr>
                                    <tr>
                            ...
                            <Title title={'(ii)'} titleAlt={'Cookies'} titleThird={'analíticas y de rendimiento'} />
                            ...
                            <p>Recuerda que la información obtenida por estas cookies no permite identificarte. Toda la información obtenida es agregada y, por lo tanto, anónima. La función de estas cookies es obtener estadísticas e informes que permiten mejorar el funcionamiento de nuestro sitio web.</p>
                            <p>Estas cookies solo se instalan en el dispositivo cuando las aceptas.</p>
                            ...
                            <Title title={'(iii)'} titleAlt={'Cookies'} titleThird={'publicitarias'} />
                            <p>Estas cookies se utilizan almacenan información del comportamiento de los usuarios obtenida a través de la observación continuada de sus hábitos de navegación para mostrar anuncios que pensamos que son relevantes para los usuarios. También se utilizan para limitar el número de veces que como usuario ves un anuncio, así como para ayudar a medir la eficacia de las campañas publicitarias. Estas cookies no almacenan de forma directa su información personal, sino que utilizan como base la identificación única de su navegador y dispositivo de Internet. Esta información se puede compartir con otras organizaciones como los anunciantes.</p>
                            <p>Estas cookies solo se instalan en el dispositivo del usuario cuando éste las acepta.</p>
                            <Title title={'(iv)'} titleAlt={'Cookies'} titleThird={'de publicidad comportamental'} />
                            <p>Estas cookies tienen una finalidad publicitaria. Permiten almacenar información sobre la navegación de los usuarios a través de sesiones de navegación, presentando publicidades relacionadas directamente con sus intereses o sus búsquedas anteriores. Suelen ser cookies que provienen de plataformas de compra programática, adexchanges, DSP, SSP, DMP y otras tecnologías de compraventa automatizada publicitaria. Algunas cookies provienen de acuerdos que tenemos con terceros.</p>
                            <Title title={'(v)'} titleAlt={'Cookies'} titleThird={'Sociales'} />
                            <p>Algunos servicios pueden utilizar conectores con diversas redes sociales: Facebook, Twitter o Instagram. Al utilizar el registro social, autorizas a la red social a colocar cookies. Estas cookies añaden la componente social a tu navegación.</p>
                            <Title title={'¿Cuáles son los plazos de conservación?'} />
                            <p>Las cookies utilizadas serán conservadas en su dispositivo durante el tiempo necesario para la finalidad por la que fueron instaladas, y como máximo, durante el plazo concreto de duración de cada cookie, salvo que decidas retirar su consentimiento o eliminarlas a través de las opciones de configuración de tu navegador.</p>
                            <Title title={'¿Transferencias internacionales?'} />
                            <p>Algunos de los datos personales obtenidos a través de cookies de terceros serán objeto de transferencias internacionales. Para obtener más información sobre las transferencias internacionales a terceros países realizadas por cada tercero, accede a sus respectivas Políticas de Privacidad mostradas en la presente Política de Cookies.</p>
                            ...
                            <p>Puedes obtener más información sobre el tratamiento de sus datos realizado así como sobre el modo de ejercitar sus derechos en nuestra <a className='color-primary no-link' href='/co/politica-privacidad'><b>Política de Privacidad</b></a>.</p>
