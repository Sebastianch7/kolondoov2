...
function ComparadorStreamingCo() {
  return (
    <div>
      <MetaData
        titulo={
          "Comparador de Energía para Hogares: ahorra y contrata | Vuskoo"
        }
        descripcion={
          "Encuentra las mejores tarifas de energía. Compara precios, planes y beneficios, simplificamos tu elección para que optimices tu consumo de manera eficiente"
        }
      />
