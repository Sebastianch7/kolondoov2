...
function ComparadorAutoconsumo() {
    return (
        <div>
            <MetaData titulo={'Comparador de Tarifas de Autoconsumo: encuentra la opción ideal | Vuskoo'} descripcion={'El comparador de tarifas luz Vuskoo te muestra el precio de la potencia, el coste de la energía y más. Explora las ofertas y ahorra en tu factura de luz.'}/>
