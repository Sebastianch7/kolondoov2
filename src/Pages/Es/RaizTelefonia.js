...
export default function RaizTelefonia() {
  ...
  useEffect(() => {
    const fetchTariffs = async () => {
      try {
        const response = await getExtraOffer(
  ...
  return (
    <>
      <MetaData
        titulo={
          "Comparador de Internet y Telefonía: descubre las Ofertas | Vuskoo"
        }
        descripcion={
          "Encuentra las mejores ofertas en Internet y telefonía con nuestro comparador. Compara precios, planes, soluciones y beneficios para tomar decisiones informadas"
        }
      />
      ...
      <Container className="mt-md-5 mt-xl-1">
        ...
        <TitleSection
          ...
          text1={
            "¿En busca de las mejores <b>ofertas de Internet y Móvil?</b> Te contamos lo más importante a la hora de decidirte por una tarifa:"
          }
        />
