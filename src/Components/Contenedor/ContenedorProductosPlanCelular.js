...
import {
  fetchFilterPlanCelular,
  fetchTarifasPlanCelular,
...
function ContenedorProductosPlanCelular() {
  ...
  const filterByBrand = useCallback(
    ...
    [filterBrand] // Dependencia de filterBrand
  );
  ...
  const filterByPrice = useCallback(
    (item) =>
      filterPrice !== null
        ...
        : true,
    [filterPrice] // Dependencia de filterPrice
  );
  ...
  const filterByPromo = useCallback(
    (item) =>
      filterPromo !== false
        ...
        : true,
    [filterPromo] // Dependencia de filterPromo
  );
        ...
        <Container>
          <Row className="justify-content-around">
            <Col xs={12} md={12} xl={3}>
              <Row>
                {!isMobile ? (
                  <Col className="my-3 font-semibold" xs={6} md={12} xl={5}>
                    Filtrar por:{" "}
                  </Col>
                ) : (
                      ...
                      <div className="my-2">
                        ...
                        <div className="my-2">
                          <Form.Switch
                            ...
                            onChange={() =>
                              setFilterTechnology(!filterTechnology)
                            }
            ...
            <Col md={12} xl={8}>
              <Row>
                <Col key={filterBrand} className="my-2" xl={6}>
                  Mostrando:{" "}
                  <span className="font-bold">{filtros?.length}</span>{" "}
                  resultados de{" "}
                  <span className="font-bold">{Tarifas.length}</span>
...
export default ContenedorProductosPlanCelular;
